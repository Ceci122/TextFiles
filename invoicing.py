...
def record_invoice(invoice_file: TextIO,
    ...
    :param last_line_ptr: The position of the start of the last line in the file.
                This will be obtained by the previous call the 'record_invoice'.
    :return: The position fo the start of the last line in the file.
            This can be user in subsequent calls to 'record_invoice'
    """
